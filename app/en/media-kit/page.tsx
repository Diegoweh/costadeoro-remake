...
export const metadata: Metadata = {
  ...
  description: "Press resources for Hotel Costa de Oro: informative PDF, gallery, map and institutional video.",
};

const LINKS = [
  { href: "/mediakit.pdf", icon: "/images/iconos/pdfinfo.png", label: "Informative PDF" },
  { href: "https://www.instagram.com/costadeorobeachhotel/", icon: "/images/iconos/galeria.png", label: "Gallery" },
  { href: "https://goo.gl/maps/QhpnqnSkDbSNutxHA", icon: "/images/iconos/mapa.png", label: "Map" },
...
export default function MediaKitPageEn() {
  return (
    <section className="grid min-h-screen grid-cols-1 pt-20 sm:pt-24 lg:grid-cols-[1.25fr_0.85fr] lg:pt-28">
      <div className="relative h-[42vh] lg:h-auto">
        <Image src="/images/mediakit/mediakit.webp" alt="View of Hotel Costa de Oro facing the ocean" fill priority className="object-cover" />
      </div>
      ...
      <div className="flex flex-col items-center justify-center bg-white px-6 py-10 text-center sm:px-10 lg:items-start lg:px-16 lg:text-left">
        <div className="flex flex-col items-center gap-4 lg:items-start">
          ...
          <p className="max-w-md text-lg text-[#504e4e]">
            In this menu you will find detailed information about what our Hotel in Mazatlán has to offer.
          </p>
        </div>
